function SevnJS(){const license="copyrights mGeek.in and Dr. Prateek Raj Gautam, soon to be released under Apache 2.0";const version=`v0.9.4`;const grab=(parentidstr)=>{var match=parentidstr.match(/^([^\[]*)\[*(\d*)\]*$/mi);var parentid=match[1];var parentElement=null;try{if(parentid instanceof Object==true){parentElement=parentid}
